...
/**
 * Represents a single change in its default projection as returned by the REST service.
 */
@Resource
...
public class EventRepresentation {
    ...
    @ApiModelProperty(
            access = "public",
            name = "origin",
            notes = "link to the cause of the event - e.g. a link to a change in customer.")
