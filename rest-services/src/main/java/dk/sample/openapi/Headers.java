...
/**
 * add or complement existing standard headers for the openapi documentation
 */
public class Headers {
    ...
    /**
     *
     * The pattern here could be removed as this would open for ny type of support in the service and that would be a better
